...
class WPBakeryShortCode_bt_blog_grid extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		wp_enqueue_script('dana-html5lightbox');
		if($layout_type == 'bt-grid-masonry') wp_enqueue_script('dana-isotope');
...
vc_map(array(
	...
	'params' => array(
		array(
			...
			'admin_label' => true,
			'description' => __('Select layout display in this element.', 'dana')
		),
		array(
			'type' => 'dropdown',
			'class' => '',
		...
		array (
			...
			'description' => esc_html__( 'Note: By default, all your posts will be displayed. If you want to narrow output, select category(s) above. Only selected categories will be displayed.', 'dana' )
		),
		array (
			'type' => 'textfield',
		...
		array(
			...
			'value' => 'full',
			'group' => __('Item Setting', 'dana'),
			'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size.', 'dana' ),
		),
		array(
			'type' => 'textfield',
			'class' => '',
			'heading' => __('Excerpt Limit', 'dana'),
			'param_name' => 'excerpt_limit',
			'value' => 20,
			'group' => __('Item Setting', 'dana'),
			'description' => __('Please, Enter number excerpt limit of post in this element.', 'dana')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			'heading' => __('Excerpt More', 'dana'),
			'param_name' => 'excerpt_more',
			'value' => '.',
			'group' => __('Item Setting', 'dana'),
			'description' => __('Please, Enter text excerpt more of post in this element.', 'dana')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			'heading' => __('Readmore Text', 'dana'),
			'param_name' => 'readmore_text',
			'value' => 'Read More',
			'group' => __('Item Setting', 'dana'),
			'description' => __('Please, Enter text of label button readmore in this element.', 'dana')
		),
		array(
			'type' => 'dropdown',
			'class' => '',
