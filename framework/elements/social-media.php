...
vc_map(array(
	...
	'params' => array(
		...
		array(
			...
			'description' => esc_html__( 'Please, select logo for option - social_media.', 'dana' ),
			'params' => array(
				array(
					'type' => 'textfield',
					'heading' => 'Name',
					'param_name' => 'name',
					'value' => '',
					'description' => esc_html__( 'Enter text used as name of social.', 'dana' ),
					'admin_label' => true,
				),
				array(
					'type' => 'textfield',
					'class' => '',
					'heading' => __('Icon', 'dana'),
					'param_name' => 'icon',
				...
				array(
					...
					'param_name' => 'link',
					'description' => esc_html__( 'Add link of social in this element.', 'dana' )
				),
			)
		),
		array(
