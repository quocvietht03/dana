...
vc_map(array(
	...
	'params' => array(
		...
		array (
			...
			'description' => esc_html__( 'Note: By default, all your members will be displayed. If you want to narrow output, select category(s) above. Only selected categories will be displayed.', 'dana' )
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__( 'Post IDs', 'dana' ),
			'param_name' => 'post_ids',
			'group' => __('Data Setting', 'dana'),
			'description' => esc_html__( 'Enter post IDs to be excluded (Note: separate values by commas (,)).', 'dana' ),
		),
		array (
			'type' => 'textfield',
