...
Redux::setSection( $opt_name, array(
	...
	'fields'           => array(
		...
		array(
			'id'       => 'shop_top_bar',
			'type'     => 'switch',
			'title'    => esc_html__( 'Enable Top Bar', 'dana' ),
			'subtitle' => esc_html__( 'Turn on to show the top bar on the top.', 'dana' ),
			'default'  => false
		),
		array(
			...
			'right'   => false,
			'left'   => false,
			'title'    => esc_html__( 'Top Bar Space', 'dana' ),
			'subtitle' => esc_html__( 'Control the bottom margin the top bar.', 'dana' ),
			'default'  => array(
				'margin-bottom' => '30px'
			),
		...
		array(
			...
			'type'          => 'slider',
			'title'         => esc_html__( 'Product Per Page', 'dana' ),
			'subtitle'      => esc_html__( 'Controls the number of product on the page.', 'dana' ),
			'default'       => 10,
			'min'           => 1,
			'step'          => 1,
			'max'           => 20,
		...
		array(
			...
			'type'          => 'slider',
			'title'         => esc_html__( 'Product Per Row', 'dana' ),
			'subtitle'      => esc_html__( 'Controls the number of product on the row.', 'dana' ),
			'default'       => 3,
			'min'           => 2,
			'step'          => 1,
			'max'           => 4,
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Single Product', 'dana' ),
	'id'               => 'bt_product',
	'subsection'       => true,
	'fields'           => array(
		array(
