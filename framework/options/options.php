<?php
    ...
    $args = array(
        ...
        'menu_title'           => esc_html__( 'Theme Options', 'dana' ),
        'page_title'           => esc_html__( 'Theme Options', 'dana' ),
    ...
    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-docs',
        'href'  => '#',
        'title' => esc_html__( 'Documentation', 'dana' ),
    );

    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-support',
        'href'  => '#',
        'title' => esc_html__( 'Support', 'dana' ),
    );

    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-extensions',
        'href'  => '#',
        'title' => esc_html__( 'Extensions', 'dana' ),
    );

    // SOCIAL ICONS -> Setup custom links in the footer for quick links in your panel footer icons.
    $args['share_icons'][] = array(
        'url'   => '#',
        'title' => esc_html__('Visit us on GitHub', 'dana'),
        'icon'  => 'el el-github'
        //'img'   => '', // You can use icon OR img. IMG needs to be a full URL.
    );
    $args['share_icons'][] = array(
        'url'   => '#',
        'title' => esc_html__('Like us on Facebook', 'dana'),
        'icon'  => 'el el-facebook'
    );
    $args['share_icons'][] = array(
        'url'   => '#',
        'title' => esc_html__('Follow us on Twitter', 'dana'),
        'icon'  => 'el el-twitter'
    );
    $args['share_icons'][] = array(
        'url'   => '#',
        'title' => esc_html__('Find us on LinkedIn', 'dana'),
        'icon'  => 'el el-linkedin'
    );
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = '<p>'.esc_html__('Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable:', 'dana').' <strong>'.$v.'</strong></p>';
    } else {
        $args['intro_text'] = '<p>'.esc_html__('This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'dana').'</p>';
    }

    // Add content after the form.
    $args['footer_text'] = '<p>'.esc_html__('This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'dana').'</p>';
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => esc_html__( 'Theme Information 1', 'dana' ),
            'content' => '<p>'.esc_html__( 'This is the tab content, HTML is allowed.', 'dana' ).'</p>'
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => esc_html__( 'Theme Information 2', 'dana' ),
            'content' => '<p>'.esc_html__( 'This is the tab content, HTML is allowed.', 'dana' ).'</p>'
        )
    );
    ...
    $content = '<p>'.esc_html__( 'This is the sidebar content, HTML is allowed.', 'dana' ).'</p>';
    ...
    */
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            //$sections = array();
            $sections[] = array(
                'title'  => esc_html__( 'Section via hook', 'dana' ),
                'desc'   => '<p class="description">'.esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'dana' ).'</p>',
