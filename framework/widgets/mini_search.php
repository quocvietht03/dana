...
class dana_Widget_Mini_Search extends WP_Widget {
	
	function __construct() {
		parent::__construct(
			'bt_widget_mini_search', // Base ID
			__('Mini Search', 'dana'), // Name
			array('description' => __('Display the mini search in the menu right sidebar.', 'dana'),) // Args
        );
    ...
    function form($instance) {
		...
		?>
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'dana'); ?></label>
...
/**
 * Class dana_Widget_Mini_Search
 */
function register_dana_widget_mini_search() {
    register_widget('dana_Widget_Mini_Search');
}
add_action('widgets_init', 'register_dana_widget_mini_search');
