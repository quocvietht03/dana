<?php
class dana_Icon_Info_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'icon_info_widget', // Base ID
                __('Icon Info', 'dana'), // Name
                array('description' => __('Icon Info Widget', 'dana'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('font_icon')); ?>"><?php _e('Icon:', 'dana');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('meta_info')); ?>"><?php _e('Text:', 'dana');
		 ?></label>
 ...
 */
function dana_register_icon_info_widget() {
    register_widget('dana_Icon_Info_Widget');
}
add_action('widgets_init', 'dana_register_icon_info_widget');
?>
