<?php
class dana_Social_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'social_widget', // Base ID
                __('Socials', 'dana'), // Name
                array('description' => __('Social Widget', 'dana'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'dana'); ?></label>
        ...
        for ($i = 1; $i <= 12; $i++) {
            ?>
            <p>
                <label for="<?php echo esc_url($this->get_field_id('icon_social_' . $i)); ?>"><?php echo esc_html__('Social Icon', 'dana').$i; ?></label>
            ...
            <p>
                <label for="<?php echo esc_url($this->get_field_id('link_social_' . $i)); ?>"><?php echo esc_html__('Social Link', 'dana').$i; ?></label>
        ...
        <?php } ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('el_class')); ?>"><?php _e('Extra Class', 'dana'); ?></label>
...
/**
 * Class dana_Social_Widget
 */
function dana_register_social_widget() {
    register_widget('dana_Social_Widget');
}
add_action('widgets_init', 'dana_register_social_widget');
?>
