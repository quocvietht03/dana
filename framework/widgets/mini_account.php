<?php
class dana_Mini_Account_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'mini_account_widget', // Base ID
                __('Mini Account', 'dana'), // Name
                array('description' => __('Mini Account Widget', 'dana'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('login_text')); ?>"><?php _e('Login Text:', 'dana');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('logout_text')); ?>"><?php _e('Logout Text:', 'dana');
		 ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('cl_class')); ?>"><?php _e('Extra Class:', 'dana'); ?></label>
...
/**
 * Class dana_Mini_Acount_Widget
 */
function dana_register_mini_account_widget() {
    register_widget('dana_Mini_Account_Widget');
}
add_action('widgets_init', 'dana_register_mini_account_widget');
?>
