...
class VerifyTheme {
    ...
    public function verifytheme_user_name_callback()
    {
        printf(
            ...
            isset( $this->options['user_name'] ) ? esc_attr( $this->options['user_name']) : '', esc_html__('Please insert your Envato username. ','verifytheme'), esc_url('//bearsthemespremium.com/product-registration/'), esc_html__('More info','verifytheme')
        );
    }
