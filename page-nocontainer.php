...
<?php
global $dana_options;
$page_comment = (int) isset($dana_options['page_comment']) ?  $dana_options['page_comment']: 1;
$sidebar_width = (int) isset($dana_options['sidebar_width']) ?  $dana_options['sidebar_width']: 3;
