...
<?php
global $dana_options;
$fullwidth = isset($dana_options['single_store_picture_fullwidth'])&&$dana_options['single_store_picture_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($dana_options['single_store_picture_sidebar_width']) ?  $dana_options['single_store_picture_sidebar_width']: 3;
...
$single_store_picture_titlebar = isset($dana_options['single_store_picture_titlebar']) ? $dana_options['single_store_picture_titlebar']: true;
if($single_store_picture_titlebar) dana_titlebar();
?>
