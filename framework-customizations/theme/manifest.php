...
$manifest['id']                  = 'dana';
$manifest['skin']                = 'main';
$manifest['name']                = esc_html__( 'Bearsthemes', 'dana' );
$manifest['uri']                 = 'http://theme.bearsthemes.com/wordpress/dana-demo/';
$manifest['description']         = esc_html__( 'WordPress Theme', 'dana' );
