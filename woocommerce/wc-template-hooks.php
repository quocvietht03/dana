...
add_filter( 'loop_shop_per_page', 'dana_loop_shop_per_page', 20 );
function dana_loop_shop_per_page( $cols ) {
	global $dana_options;
	$cols = (int) isset($dana_options['shop_product_per_page']) ? $dana_options['shop_product_per_page']: 10;
	return $cols;
}
