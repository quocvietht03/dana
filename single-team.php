...
<?php
global $dana_options;
$fullwidth = isset($dana_options['single_team_fullwidth'])&&$dana_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($dana_options['single_team_sidebar_width']) ?  $dana_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($dana_options['single_team_titlebar']) ? $dana_options['single_team_titlebar']: true;
if($single_team_titlebar) dana_titlebar();
?>
