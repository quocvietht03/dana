...
<?php
global $dana_options;
$fullwidth = isset($dana_options['single_portolio_fullwidth'])&&$dana_options['single_portolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($dana_options['single_portolio_sidebar_width']) ?  $dana_options['single_portolio_sidebar_width']: 3;
$related_post = isset($dana_options['single_portfolio_related_post']) ? $dana_options['single_portfolio_related_post']: true;
$related_post_label = isset($dana_options['single_portfolio_related_post_label'])&&$dana_options['single_portfolio_related_post_label'] ? $dana_options['single_portfolio_related_post_label']: esc_html__('Portfolio Related', 'dana');
$related_post_count = (int) isset($dana_options['single_portfolio_related_post_count'])&&$dana_options['single_portfolio_related_post_count'] ? $dana_options['single_portfolio_related_post_count']: 3;
$related_post_per_row = (int) isset($dana_options['single_portfolio_related_post_per_row'])&&$dana_options['single_portfolio_related_post_per_row'] ? $dana_options['single_portfolio_related_post_per_row']: 3;
...
$single_portfolio_titlebar = isset($dana_options['single_portfolio_titlebar']) ? $dana_options['single_portfolio_titlebar']: true;
if($single_portfolio_titlebar) dana_titlebar();
?>
